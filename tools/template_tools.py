...
class TemplateTools():
  ...
  def copy_landing_page_template_to_project_folder(landing_page_template):
    ...
    return f"Template copied to {landing_page_template} and ready to be modified, main files should be under ./{landing_page_template}/components, you should focus on those."
