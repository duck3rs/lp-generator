...
class TaskPrompts():
  ...
  def choose_template():
    return dedent("""
      Learn the landing page templates options choose and copy 
      the one that suits the idea bellow the best, 
      YOU MUST COPY, and then YOU MUST read the components folder 
  ...
  def update_page():
    return dedent("""
      READ the ./[chosen_template]/pages/index.js 
